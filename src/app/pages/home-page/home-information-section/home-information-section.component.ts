...
export class HomeInformationSectionComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    // საწყისი კონფიგურაცია ან საჭირო ინიციალიზაცია
  }

  ngAfterViewInit(): void {
    // ამდენად ვადასტურებთ რომ ელემენტები მზად არის DOM-ში
    ...
    // ელემენტების გადაცემა AnimationService-ში ანიმაციების დასაწყებად
